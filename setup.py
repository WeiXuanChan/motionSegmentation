...
setup(
  ...
  download_url = 'https://github.com/WeiXuanChan/motionSegmentation/archive/v1.1.0.tar.gz',    # I explain this later on
  keywords = ['explicit', 'motion'],   # Keywords that define your package best
  install_requires=['numpy','autoD','scipy','multiprocessing','pickle','time','trimesh','re'],
  classifiers=[
