...
setup(
  ...
  version = '2.5.8',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/WeiXuanChan/motionSegmentation/archive/v2.5.8.tar.gz',    # I explain this later on
