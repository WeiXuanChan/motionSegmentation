...
setup(
  ...
  version = '2.7.7',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/WeiXuanChan/motionSegmentation/archive/v2.7.7.tar.gz',    # I explain this later on
